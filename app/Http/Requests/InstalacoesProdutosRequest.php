...
class InstalacoesProdutosRequest extends FormRequest
{
    /**
        ...
        $rules = [
            ...
            'produtos_id' => [
                ...
                function ($attribute, $value, $fail) {
                    if ($this->id == null && InstalacoesProdutos::where('instalacoes_id', $this->instalacoes_id)
                        ->where('produtos_id', $value)
                        ->exists()) {
                        $fail('O produto já está associado a essa instalação.');
                    }
                },
            ],
