...
class InstalacoesClientesRequest extends FormRequest
{
    /**
        ...
        $rules = [
            ...
            'clientes_id' => [
                ...
                function ($attribute, $value, $fail) {
                    if ($this->id == null && InstalacoesClientes::where('instalacoes_id', $this->instalacoes_id)
                        ->where('clientes_id', $value)
                        ->exists()) {
                        $fail('O cliente já está associada a essa instalação.');
                    }
                },
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'clientes_id.required' => 'O id da cliente é obrigatório.',
