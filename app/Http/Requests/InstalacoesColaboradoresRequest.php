...
class InstalacoesColaboradoresRequest extends FormRequest
{
    /**
        ...
        $rules = [
            ...
            'colaboradores_id' => [
                ...
                function ($attribute, $value, $fail) {
                    if ($this->id == null && InstalacoesColaboradores::where('instalacoes_id', $this->instalacoes_id)
                        ->where('colaboradores_id', $value)
                        ->exists()) {
                        $fail('O colaborador já está associado a essa instalação.');
                    }
                },
            ],
